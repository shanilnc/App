...
export default function TeacherSignup() {
  ...
  return (
    <div className="min-h-screen bg-[#F5EFE0] py-12 px-4 relative overflow-hidden">
      {/* Decorative circles */}
      <div className="absolute top-10 right-10 w-32 h-32 bg-blue-200 rounded-full opacity-40 blur-2xl"></div>
      <div className="absolute bottom-20 left-10 w-40 h-40 bg-indigo-200 rounded-full opacity-40 blur-2xl"></div>
        ...
        <Card className="bg-white shadow-2xl border-0 rounded-[2.5rem] overflow-hidden">
          <div className="p-10">
            <div className="text-center mb-8">
              <h1 className="text-4xl mb-3 text-black">Join as Teacher</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <Label htmlFor="institution" className="text-gray-700 text-sm mb-2 block">Institution Name *</Label>
                  <Input
                    id="institution"
                    name="institution"
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <Label htmlFor="subjects" className="text-gray-700 text-sm mb-2 block">Subjects Taught *</Label>
                  <Input
                    id="subjects"
                    name="subjects"
                    type="text"
